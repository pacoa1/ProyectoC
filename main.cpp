...
#include "Personas.h" // Donde están los objetos de mi proyecto
#include "Descripcion.h" // Donde están los objetos de mi proyecto
using namespace std;
...
int main (){
    ...
    cin>>temperatura;
    p1.setTemperatura(temperatura);
    p1.setTemperatura(temperatura);
    if (p1.getTemperatura() >= 36.0 && p1.getTemperatura() < 37.0) {
    cout << "El paciente tiene temperatura normal" << endl;
    }
    else if (p1.getTemperatura() >= 37.0) {
    cout << "El paciente tiene la temperatura alta" << endl;
    }
    else {
    cout << "El paciente tiene la temperatura baja" << endl;
    }
    ...
    cout << "Explica la enfermedad del paciente: " << endl;
    cin.ignore(); // Ignorar el carácter de nueva línea residual en el búfer
    getline(cin, explicacion);

    cout << "Menciona cuántos días lleva el paciente enfermo: ";
    cin >> dias_sintomas;
   ...
   else if (num==6)
   {
    ...
    cout<<p1.getTemperatura()<<endl;
    cout<<d1.getPadecimiento()<<endl;
    cout<<d1.getDias_sintomas()<<" días con sintomas presentes "<<endl;
